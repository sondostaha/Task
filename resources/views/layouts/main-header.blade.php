									...
									<div class="menu-header-content bg-primary text-right">
										<div class="d-flex">
											...
											<span class="badge badge-pill badge-warning mr-auto my-auto float-left">
												...
												<a href="{{route('marke_as_read')}}" id="mark">تعيين قراءة الكل</a>
											</span>
										</div >
										<div id="notifications_count">
											<p class="dropdown-title-text subtext mb-0 text-white op-6 pb-0 tx-12 ">لديك عدد من الاشعارات الغير مقروءة : {{auth()->user()->unreadNotifications->count()}}</p>
										</div>
									</div>
